          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item">
                <a className="nav-link" href="tech-index.html">
                  Home
                </a>
              </li>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_05.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_07.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_12.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_13.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_14.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_15.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_16.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_17.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
                              ...
                              <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <div className="blog-box">
                                  <div className="post-media">
                                    <a href="tech-single.html" title="">
                                      <img
                                        src="assets/upload/tech_menu_18.jpg"
                                        alt=""
                                        className="img-fluid"
                                      />
                                      <div className="hovereffect"></div>
              ...
              <li className="nav-item">
                <a className="nav-link" href="tech-category-01.html">
                  Gadgets
                </a>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <a className="nav-link" href="tech-category-03.html">
                  Reviews
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="tech-contact.html">
                  Contact Us
                </a>
              </li>
            </ul>
